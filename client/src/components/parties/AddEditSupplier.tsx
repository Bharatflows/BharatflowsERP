...
export function AddEditSupplier({ supplierId, onSave, onCancel }: AddEditSupplierProps) {
  ...
  useEffect(() => {
    if (supplierId) {
      const fetchSupplier = async () => {
        setLoading(true);
        try {
          const response = await partiesService.getById(supplierId);
          ...
          if (supplier) {
            setFormData({
              ...
              address: supplier.billingAddress?.address || "",
              city: supplier.billingAddress?.city || "",
              state: supplier.billingAddress?.state || "",
              pincode: supplier.billingAddress?.pincode || "",
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (supplierId) {
        await updateMutation.mutateAsync({ id: supplierId, data: partyData });
      } else {
      ...
      <div className="mb-8">
        ...
        <div className="bg-gradient-to-r from-primary to-primary/80 text-white px-8 py-6 rounded-2xl shadow-lg shadow-primary/20">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold">{supplierId ? "Edit Supplier" : "Add New Supplier"}</h2>
              <p className="text-blue-100 mt-1">
                {supplierId ? "Update supplier details and information" : "Enter supplier details to add them to your vendor list"}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Supplier and contact details</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Supplier Company Pvt Ltd"
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Supplier location details</p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Payment terms and opening balance</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="creditDays" className="text-foreground font-medium">Payment Terms (Days)</Label>
                <Input
                  id="creditDays"
                  type="number"
